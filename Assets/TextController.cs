...
public class TextController : MonoBehaviour
{
    ...
    void in_closet()
    {
        text.text = "Inside the closet you see a cleaner's uniform that looks about your size! " +
                    "Seems like your day is looking-up! You can dress like a cleaner and walk out like nothing happened! \n\n" +
    ...
    void corridor_3() {
        text.text = "You're standing back in the corridor, now convincingly dressed as a cleaner. " +
                    "You strongly consider the run for freedom, or you can get back to cell like a coward. \n\n" +
    ...
    void cell()
    {
        text.text = "Why is life so tough.... You endup in a prison cell because of drinking water" +
                    ", you really want to escape. There are " +
    ...
    void mirror()
    {
        text.text = "The dirty old mirror on the wall seems loose. I guess you can take it\n\n" +
